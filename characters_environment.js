...
function startGame()
  {
    GameStatus = "start";
    documents.getElementById("status").innerHTML = "Gameis loading";
  }
...
console.log("noseX =" +noseX +" ,noseY = "+ noseY);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Any play button to start the game and Play ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
